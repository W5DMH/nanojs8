...
//
// NANOJS8 MODIFICATION (L7.5): Original FT8 value was { 3, 1, 4, 0, 6, 5, 2 }.
// We've replaced it with the JS8 Normal-mode Costas pattern (Type::ORIGINAL
// in gfsk8 / JS8Call), which is { 4, 2, 5, 6, 1, 3, 0 }. The JS8 frame
// structure (79 symbols total, 3 sync blocks of 7 at positions 0/36/72,
// 58 data symbols) is identical to FT8 — only the sync values differ.
// This single-byte-array change converts the entire ft8_lib sync detector
// from FT8 to JS8 Normal without any code modifications elsewhere.
//
// See: components/nanojs8_gfsk8/src/JS8.h, Costas::COSTAS_ORIGINAL.
